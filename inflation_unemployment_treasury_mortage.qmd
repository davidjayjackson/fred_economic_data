---
title: "Federal Reserve Ecomomic Data (FRED)"
format:
  html:
    code-fold: true
jupyter: python3
...
```
### Begin Analysis of Unemployment Data (UNRATE)
...
```
### Inflation Rate Data (Consumer Price Index: CPI)
Index 1982-1984=100, Monthly, Not Seasonally AdjustedJan 1913 to Aug 2023 (4 days ago)
